...
(defun bold-response-to-file (run vp taskid verbose start end)
  ...
  (let (
    ...
    (ensure-directories-exist  (concatenate 'string "/home/rob/Desktop/actrneuro/fang06_preofficial_ACT-R_7/log/bolds/run-" run "/"))
    (ensure-directories-exist  (concatenate 'string "/home/rob/Desktop/actrneuro/fang06_preofficial_ACT-R_7/log/bolds/run-" run "/" vp "/"))
    (ensure-directories-exist  (concatenate 'string "/home/rob/Desktop/actrneuro/fang06_preofficial_ACT-R_7/log/bolds/run-" run "/" vp "/" taskid "/"))
    ...
    (with-open-file (*standard-output*
        (concatenate 'string  "/home/rob/Desktop/actrneuro/fang06_preofficial_ACT-R_7/log/bolds/run-" run "/" vp "/" taskid "/bold-response.dat")
            :direction :output
            :if-exists :supersede
            :if-does-not-exist :create)
