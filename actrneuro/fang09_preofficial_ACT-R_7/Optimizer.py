...
parser.add_argument('--n_iterations', type=int,   help='Number of iterations performed by the optimizer', default=1200)
...
NS.start()
print("NS started ")
os.system("echo \"new run\" >> optimizer.log")
...
w = MyWorker(nameserver='127.0.0.1', run_id='ACT-R')
...
bohb = BOHB(  configspace = w.get_configspace(),
              run_id = 'ACT-R', nameserver='127.0.0.1',
