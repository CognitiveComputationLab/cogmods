...
(define-model nterm
 ...
 (sgp
      ...
      ;; RT LF AND ANS WILL BE CHANGED IN LOAD FANG
      :v t
      :esc t
      :ncnar nil
      :bll .5
      ...
      :show-focus t :needs-mouse nil :trace-detail low ;v ;high
      ...
      ;; :retrieval-request-hook captain-retrieval
      ;; :conflict-set-hook captain-confliction-resolution
      ;; :chunk-add-hook captain-dm-chunk-add
      ;; :chunk-merge-hook captain-dm-chunk-merge
      ;; :retrieved-chunk-hook captain-retrieval-done
...
(chunk-type term value name)
 ...
 (add-dm
    ...
    (s-term isa term value "Schliessen" name schliessen)
