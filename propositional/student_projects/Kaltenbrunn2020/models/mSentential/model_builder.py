"""Builder for Mental Models and Fully Explicit Models by Guerth:
https://github.com/CognitiveComputationLab/cogmods/blob/master/modal/student_projects/2019_guerth/models/mmodalsentential/model_builder.py

This module implements a model builder based on the 'Model Theory'
"""
from itertools import product
import numpy as np
from .assertion_parser import Expr, preprocess_modals, parse_one
