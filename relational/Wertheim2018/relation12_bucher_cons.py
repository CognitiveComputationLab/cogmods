...
class Relational12buchercons(pytry.NengoTrial):
    def params(self):
    ...
    def model(self, p):
        ...
        vocab_space.populate('OBJ1; OBJ2; OBJ3; X; Y')

        vocab_rule = spa.Vocabulary(p.D)
        vocab_rule.populate('OBJ1; OBJ2; OBJ3; BELOW; ABOVE; LEFT; RIGHT; S; O; V')

        vocab_obj = vocab_rule.create_subset(['OBJ1', 'OBJ2', 'OBJ3'])
        ...
        with model:
            ...
            def input(t):
                ...
                if t<0.4:
                    ...
                    return 'OBJ3*S+LEFT*V+OBJ1*O'
                elif t<1.2:
                    return 'OBJ3*S+LEFT*V+OBJ2*O'
            ...
            display = nengo.Node(display_node, size_in=6)
    ...
    def evaluate(self, p, sim, plt):
        ...
        final_data = data[-1]
        obj1x, obj1y, obj2x, obj2y, obj3x, obj3y = final_data
        if obj3x<obj1x<obj2x:
            score = 1
        else:
            score = 0
