...
class Relational12_5(pytry.NengoTrial):
    def params(self):
    ...
    def model(self, p):
        ...
        vocab_rule.populate('OBJ1; OBJ2; OBJ3; OBJ4; OBJ5; BELOW; ABOVE; LEFT; RIGHT; S; O; V')

        vocab_obj = vocab_rule.create_subset(['OBJ1', 'OBJ2', 'OBJ3', 'OBJ4', 'OBJ5'])
    ...
    def evaluate(self, p, sim, plt):
        ...
        final_data = data[-1]
        obj1x, obj1y, obj2x, obj2y, obj3x, obj3y, obj4x, obj4y, obj5x, obj5y = final_data
        if obj1x<obj2x<obj3x<obj4x<obj5x:
            score = 1
        else:
            score = 0
        ...
        if plt:
            ...
            plt.legend(loc='best', labels=['1','2','3','4','5'])
            plt.ylabel('x value')
            plt.subplot(2,1,2)
