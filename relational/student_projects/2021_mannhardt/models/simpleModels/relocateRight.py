...
class RelocateRight(ccobra.CCobraModel):
    def __init__(self, name='RelocateRight'):
        super(RelocateRight, self).__init__(name, ["spatial-relational"], ["single-choice", "verify"])
