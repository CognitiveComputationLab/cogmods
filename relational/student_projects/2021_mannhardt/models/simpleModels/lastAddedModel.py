...
class LastAddedObject(ccobra.CCobraModel):
    def __init__(self, name='LastAddedObject'):
        super(LastAddedObject, self).__init__(name, ["spatial-relational"], ["single-choice", "verify"])
