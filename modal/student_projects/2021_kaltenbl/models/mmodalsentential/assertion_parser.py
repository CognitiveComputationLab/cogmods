"""Sentential and Modal Assertion Parser
...
def count_operators(ccobra_list, sententinal_only=True):
    """Count number of operators in ccobra_list

    Arguments:
        ccobra_list {list} -- list of clauses & operators in polnish notation (CCobra style)

    Keyword Arguments:
        sentential_only {bool} -- Count only sentential connectives (default: {True})
