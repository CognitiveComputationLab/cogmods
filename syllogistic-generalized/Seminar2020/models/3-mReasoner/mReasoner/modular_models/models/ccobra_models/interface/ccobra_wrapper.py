...
class CCobraWrapper:
    ...
    def predict(self, item, **kwargs):
        # Friedrich: Use the generalized Syllogism to support "Most" and "Few"
        syl_enc = ccobra.syllogistic_generalized.GeneralizedSyllogism(item).encoded_task
        # syl_enc = ccobra.syllogistic.Syllogism(item).encoded_task
        ...
        return ccobra.syllogistic_generalized.decode_response(conclusion, item.task)
