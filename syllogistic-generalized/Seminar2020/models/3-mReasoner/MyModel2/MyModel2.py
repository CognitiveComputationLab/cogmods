...
Parameters = namedtuple('Parameters', 'disallow_nvc max_weakenings max_tries max_size order_from_choices strategic most_not', defaults=(False, 3, 100, 21, False, True, True))
...
class MyModel(ccobra.CCobraModel):
    ...
    params = params_2020_base # modify for ccobra run

    def __init__(self, log_level=logging.DEBUG):

        super(MyModel, self).__init__(
            'Baseline Model', ['syllogistic-generalized'], ['single-choice'])
