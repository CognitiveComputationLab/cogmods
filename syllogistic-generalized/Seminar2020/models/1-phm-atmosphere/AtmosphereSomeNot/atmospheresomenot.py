...
class AtmosphereSomeNotModel(ccobra.CCobraModel):
    def __init__(self, name='AtmosphereSomeNot'):
        super(AtmosphereSomeNotModel, self).__init__(name, ['syllogistic-generalized'], ['single-choice'])
    ...
    def determine_answer(self, rep):
        ...
        ## Replace Most...not and Few...not with Some...not
        if (quant == "+" and pol == "-") or (quant == "-" and pol == "-"):
            quant = "--"
            pol = "-"
