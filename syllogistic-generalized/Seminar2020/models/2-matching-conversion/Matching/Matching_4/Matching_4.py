...
class Matching_4(ccobra.CCobraModel):
    def __init__(self, name='Matching_4'):
        ...
        self.mood_to_rank = {'No': 6, 'Most not': 5, 'Some': 4, 'Some not': 3, 'Few': 2, 'Most': 1, 'All': 0}
        self.rank_to_mood = {6: ['No'], 5: ['Most not'], 4: ['Some'],  3: ['Some not'], 2: ['Few'], 1: ['Most'], 0: ['All']}
