...
class Matching_1(ccobra.CCobraModel):
    def __init__(self, name='Matching_1'):
        ...
        self.mood_to_rank = {'No': 4, 'Most not': 3, 'Some not': 2, 'Some': 2, 'Most': 1, 'Few': 1, 'All': 0}
        self.rank_to_mood = {4: ['No'], 3: ['Most not'], 2: ['Some not', 'Some'], 1: ['Most', 'Few'], 0: ['All']}
