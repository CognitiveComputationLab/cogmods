...
class AtmosphereImproved(ccobra.CCobraModel):
    def __init__(self, name='AtmosphereImproved'):
        super(AtmosphereImproved, self).__init__(name, ['syllogistic-generalized'], ['single-choice'])
