...
class PreferredModelImproved(ccobra.CCobraModel):
    def __init__(self, name='Preferred Model Improved'):
        super(PreferredModelImproved, self).__init__(name, ['syllogistic-generalized'], ['single-choice'])
