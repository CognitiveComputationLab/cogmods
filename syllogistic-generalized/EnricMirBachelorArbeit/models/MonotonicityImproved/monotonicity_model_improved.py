...
def solve(Q1, A, B, Q2, C, D):
    # one Q is All
    if (Q1 == "All" or Q1 == "Most"): # A is subset of B
        return monotonicity_all(Q2, C, D, A, B)
    elif (Q2 == "All" or Q2 == "Most"): # C is subset of D
        return monotonicity_all(Q1, A, B, C, D)
    # one Q is No
    elif (Q1 == "No" or Q2 == "Most not"):
        return monotonicity_no(Q2, C, D, A, B)
    elif (Q2 == "No" or Q2 == "Most not"):
        return monotonicity_no(Q1, A, B, C, D)
    else:
        return "NVC"

class MonotonicityModelImproved(ccobra.CCobraModel):
    def __init__(self, name='MonotonicityModelImproved'):
        super(MonotonicityModelImproved, self).__init__(name, ['syllogistic-generalized'], ["single-choice"])
