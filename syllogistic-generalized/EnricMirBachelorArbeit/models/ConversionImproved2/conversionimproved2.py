...
class ConversionImproved2(ccobra.CCobraModel):
    def __init__(self, name='ConversionImproved2'):
        self.params = {"reverse_first_premise": 1, "reverse_second_premise": 0.2, "All": 1, "No": 0,
                       "Some": 0, "Some not": 0.4,
                       "Most": 0.4, "Few": 0.4,
                       "Most not": 0.4, "Few not": 0.4}
        supported_domains = ['syllogistic-generalized']
        supported_response_types = ['single-choice']
        super(ConversionImproved2, self).__init__(
    ...
    def predict(self, item, **kwargs):
        ...
        for p1 in premises1:
            for p2 in premises2:
                if p1 == ["All", a, b]:
                    if p2 == ["All", b, c]:
                        self.addall(predictions, [["All", a, c], ["All", c, a]])
                    ...
                    if p2 in [["All", c, b],["All", b, c]]:
                        self.addall(predictions, [["All", a, c], ["All", c, a]])
                    elif p2 in [["Some", c, b], ["Some", b, c]]:
