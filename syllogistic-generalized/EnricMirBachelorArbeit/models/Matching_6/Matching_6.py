...
class Matching_6(ccobra.CCobraModel):
    def __init__(self, name='Matching_6'):
        ...
        self.rank_to_mood = {5: ['No'], 4: ['Most not'], 3: ['Some not'],  2: ['Few'], 1: ['Most'], 0: ['All']}
        super(Matching_6, self).__init__(
