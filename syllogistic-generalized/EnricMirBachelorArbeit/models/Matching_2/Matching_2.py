...
class Matching_2(ccobra.CCobraModel):
    def __init__(self, name='Matching_2'):
        ...
        self.mood_to_rank = {'No': 5, 'Most not': 4, 'Some not': 3, 'Some': 3, 'Few': 2, 'Most': 1, 'All': 0}
        self.rank_to_mood = {5: ['No'], 4: ['Most not'], 3: ['Some', 'Some not'], 2: ['Few'], 1: ['Most'], 0: ['All']}
